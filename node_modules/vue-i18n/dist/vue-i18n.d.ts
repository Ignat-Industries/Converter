...
export declare interface ComposerDateTimeFormatting<DateTimeFormats extends Record<string, any> = {}, Locales = 'en-US', DefinedDateTimeFormat extends RemovedIndexResources<DefineDateTimeFormat> = RemovedIndexResources<DefineDateTimeFormat>, C = IsEmptyObject<DefinedDateTimeFormat> extends false ? PickupFormatPathKeys<{
     ...
     * @returns Formatted value
     */
    <Value extends number | Date | string = number, Key extends string = string, Return extends string | Intl.DateTimeFormatPart[] = string | Intl.DateTimeFormatPart[]>(value: Value, keyOrOptions: Key | ResourceKeys | DateTimeOptions<Key | ResourceKeys, Locales>): Return;
    /**
     * Datetime formatting
     *
     * @remarks
     ...
     * @returns Formatted value
     */
    <Value extends number | Date | string = number, Key extends string = string, Return extends string | Intl.DateTimeFormatPart[] = string | Intl.DateTimeFormatPart[]>(value: Value, keyOrOptions: Key | ResourceKeys | DateTimeOptions<Key | ResourceKeys, Locales>, locale: Locales): Return;
}
...
export declare interface ComposerNumberFormatting<NumberFormats extends Record<string, any> = {}, Locales = 'en-US', DefinedNumberFormat extends RemovedIndexResources<DefineNumberFormat> = RemovedIndexResources<DefineNumberFormat>, C = IsEmptyObject<DefinedNumberFormat> extends false ? PickupFormatPathKeys<{
     ...
     * @returns Formatted value
     */
    <Key extends string = string, Return extends string | Intl.NumberFormatPart[] = string | Intl.NumberFormatPart[]>(value: number, keyOrOptions: Key | ResourceKeys | NumberOptions<Key | ResourceKeys, Locales>): Return;
    /**
     * Number Formatting
     *
     * @remarks
     ...
     * @returns Formatted value
     */
    <Key extends string = string, Return extends string | Intl.NumberFormatPart[] = string | Intl.NumberFormatPart[]>(value: number, keyOrOptions: Key | ResourceKeys | NumberOptions<Key | ResourceKeys, Locales>, locale: Locales): Return;
}
